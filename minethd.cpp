...
minethd::cn_hash_fun minethd::func_selector(bool bHaveAes, bool bNoPrefetch)
{
    ...
    static const cn_hash_fun func_table[4] = {
        cryptonight_hash<ITER, MEMORY, false, false>,
        cryptonight_hash<ITER, MEMORY, false, true>,
        cryptonight_hash<ITER, MEMORY, true, false>,
        cryptonight_hash<ITER, MEMORY, true, true>
    };
...
minethd::cn_hash_fun_dbl minethd::func_dbl_selector(bool bHaveAes, bool bNoPrefetch)
{
    ...
    static const cn_hash_fun_dbl func_table[4] = {
        cryptonight_double_hash<ITER, MEMORY, false, false>,
        cryptonight_double_hash<ITER, MEMORY, false, true>,
        cryptonight_double_hash<ITER, MEMORY, true, false>,
        cryptonight_double_hash<ITER, MEMORY, true, true>
    };
